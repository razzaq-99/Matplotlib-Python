...
# sns.stripplot(data = data, x = "day", y = "total_bill",hue="sex",jitter=0.3)
...
# sns.kdeplot(data = data , x = "tip",hue="sex",multiple="stack")
sns.kdeplot(data = data ,x ="tip",hue="day",multiple="fill")
# sns.kdeplot(data = data , x = "tip",hue="sex",multiple="layer")
